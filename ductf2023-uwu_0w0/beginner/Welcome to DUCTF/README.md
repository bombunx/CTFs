...
# Solution
Search for upside down / aussieplusplus interpreter [https://aussieplusplus.vercel.app/#code](https://aussieplusplus.vercel.app/#code)
Copy the contents of the file into the interpreter and run it to get the flag
# Flag
```
